...
import com.vfurkana.caselastfm.albumdetail.databinding.FragmentAlbumDetailBinding
import com.vfurkana.caselastfm.albumdetail.viewmodel.AlbumDetailViewModel
...
class AlbumDetailFragment : BaseFragment<FragmentAlbumDetailBinding>() {
    ...
    private fun initializeWithArguments(bundle: Bundle) {
        ...
        bundle.getParcelable<Album>(KEY_EXTRAS_ALBUM)?.also {
            ...
            viewModel.getAlbumDetail(it.name, it.artistName)
        }
