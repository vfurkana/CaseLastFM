package com.vfurkana.caselastfm.common.data.service.remote.di

import com.vfurkana.caselastfm.common.BuildConfig
import com.vfurkana.caselastfm.common.data.service.remote.interceptor.LastFMResponseTypeInterceptor
import com.vfurkana.caselastfm.common.data.service.remote.interceptor.LastFMSecretInterceptor
...
object LastFMNetworkModule {
    ...
    @Provides
    @Singleton
    fun provideLastFMArtistService(retrofit: Retrofit): com.vfurkana.caselastfm.common.data.service.remote.LastFMAPI {
        return retrofit.create(com.vfurkana.caselastfm.common.data.service.remote.LastFMAPI::class.java)
    }
